...
/**
 * The GetStationData class is used to get missing data for train objects that
 * was not generated by the SubwaySimulator. This includes station names,
 * station x-coordinates, and station y-coordinates.
 * 
...
public class GetStationData {
	...
	/**
	 * Using the subway.csv file, this method populates the hashmaps with values and
	 * keys for each station code.
	 */
