...
public class NewsFetcher {
	...
	public static Article fetchNews(String query, String apiKey) {
		...
		String apiUrl = "https://api.newscatcherapi.com/v2/search?q=" + query + "&page=1&lang=en"; // Only recieve 1
																									// page
		...
		try {
			...
			if (statusCode == 200) {
				...
				System.out.println("Request failed with status code: " + statusCode); // If code = 401 API key maybe
																						// expired
			}
